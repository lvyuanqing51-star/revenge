...
st.markdown(
    ...
    div[data-testid="stMetricLabel"] div {
        ...
        /* 白底金光描边特效 */
        text-shadow: 0 0 8px #eab308, 0 0 18px rgba(234, 179, 8, 0.7), 1px 1px 2px #000000 !important;
...
if not records:
  ...
  if not df.empty:
    ...
    custom_table_html = (
        ...
        "<thead><tr>"
        '<th style="text-align:left;padding-left:20px;">玩家</th>'
